...
public class QuizResultController {
    ...
    @PostMapping(value = "/submit", params = {"userId", "firstName","quizId"})
    public ResponseEntity<?> submitQuiz(@RequestParam Long userId, @RequestParam String firstName,@RequestParam Long quizId, @RequestBody HashMap<String,String> answers) {
        ...
        quizResult.setFirstName(firstName);
